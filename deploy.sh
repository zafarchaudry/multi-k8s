...
kubectl set image deployments/client-deployment client=zafar/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=zafar/multi-worker:$SHA
